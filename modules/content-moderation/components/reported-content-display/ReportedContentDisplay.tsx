...
const ReportedContentDisplay: React.FC<ReportedContentDisplayProps> = ({ report }) => {
      ...
      <div className="space-y-6">
          ...
          <div className="flex items-start justify-between rounded-lg border bg-muted/30 p-4">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold uppercase">{REASON_LABELS[report.reason] ?? report.reason}</span>
              </div>
        ...
        <section>
          <div className="mb-4 flex items-center justify-between">
            <h3 className="text-lg font-bold">{CONTENT_TYPE_HEADINGS[type] ?? type}</h3>
